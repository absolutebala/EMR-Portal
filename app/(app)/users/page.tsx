        ...
        <div style={{ background: '#fff', borderRadius: 10, border: '1px solid var(--gm)', overflow: 'hidden' }}>
          {loading ? (
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
              <thead>
                <tr>
                  {['User', 'Employee ID', 'Role', 'Department', 'Email', 'Phone', 'Last login', 'Status', 'Actions'].map(h => (
                    ...
                    <td style={{ padding: '10px 14px' }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                        ...
                        <div>
                          ...
                          {u.department && <div style={{ fontSize: 10, color: 'var(--txm)' }}>{u.department}</div>}
                        </div>
                      </div>
                    </td>
                    <td style={{ padding: '10px 14px', fontSize: 12, color: 'var(--txm)' }}>{u.employee_id}</td>
                    <td style={{ padding: '10px 14px' }}><RoleBadge role={u.role}/></td>
                    <td style={{ padding: '10px 14px', fontSize: 12, color: 'var(--txm)' }}>{u.department || '—'}</td>
