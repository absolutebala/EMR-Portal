...
export default function FormsPageClient({ forms, userName, userRole, permissions = {} }: Props) {
  ...
  return (
    <>
      <Topbar title="Forms" userName={userName} userRole={userRole} />
      <div style={{ flex: 1, padding: '22px 24px' }}>
        ...
        <FormBuilder open={showBuilder} onClose={() => { setShowBuilder(false); setEditForm(null) }} onSaved={() => router.refresh()} editForm={editForm} />
        {assignForm && <AssignModal form={assignForm} open={!!assignForm} onClose={() => setAssignForm(null)} onSaved={() => router.refresh()} />}
