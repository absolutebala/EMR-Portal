...
export interface AppSettings {
  ...
  whatsapp_campaign_product_requested_customer: string | null
  ...
  sms_otp_template: string | null
  notification_channel: string | null
  sms_notification_type: string | null
  sms_notification_templates: Record<string, { id?: string; text?: string }> | null
...
export type WorkOrderStatus = 'unassigned' | 'assigned' | 'in_progress' | 'pending' | 'completed' | 'needs_reassignment' | 'closed'
